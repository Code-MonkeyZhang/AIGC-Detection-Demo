...
class NonescapeMiniDetector(BaseDetector):
    """基于 Nonescape Mini 模型的检测器"""
    
    def __init__(self, model_path: str):
        """
        初始化 Nonescape Mini 检测器
        
        Args:
            model_path: 模型文件路径
        """
        super().__init__("Nonescape-Mini")
    ...
    def load_model(self):
        ...
        try:
            ...
            self.model = NonescapeClassifierMini.from_pretrained(self.model_path)
            self.model.eval()
